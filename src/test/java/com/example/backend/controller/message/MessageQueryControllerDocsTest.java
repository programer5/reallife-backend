        ...
        mockMvc(restDocumentation)
                ...
                .andDo(document("messages-get",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("items[].type").type(STRING).description("메시지 타입(TEXT, SESSION 등)"),
                                fieldWithPath("items[].content").optional().type(STRING).description("메시지 내용(없을 수 있음)"),
                                fieldWithPath("items[].metadataJson").optional().type(STRING).description("메시지 메타데이터 JSON 문자열"),
                                fieldWithPath("items[].sessionId").optional().type(STRING).description("연결된 세션 ID(UUID)"),
                                fieldWithPath("items[].createdAt").type(STRING).description("생성 시각"),
                                fieldWithPath("items[].editedAt").optional().type(STRING).description("수정 시각(없으면 null)"),
                                ...
                                fieldWithPath("items[].attachments[].mediaType").optional().type(STRING).description("첨부 미디어 타입(IMAGE, VIDEO 등)"),
                                fieldWithPath("items[].attachments[].url").optional().type(STRING).description("대표 파일 URL"),
                                fieldWithPath("items[].attachments[].downloadUrl").optional().type(STRING).description("다운로드 URL"),
                                fieldWithPath("items[].attachments[].previewUrl").optional().type(STRING).description("미리보기 URL"),
                                fieldWithPath("items[].attachments[].thumbnailUrl").optional().type(STRING).description("썸네일 URL"),
                                fieldWithPath("items[].attachments[].streamingUrl").optional().type(STRING).description("스트리밍 URL"),
