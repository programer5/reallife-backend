...
public interface PostQueryRepository {
    ...
    List<Post> findFollowingFeedFirstPage(Collection<UUID> authorIds, int size);
    List<Post> findFollowingFeedNextPage(Collection<UUID> authorIds, LocalDateTime cursorCreatedAt, UUID cursorId, int size);
