...
=== 운영 상태 요약 조회
operation::admin-health-get[snippets='http-request,http-response,response-fields']

=== 실시간 상태 조회
operation::admin-health-realtime-get[snippets='http-request,http-response,response-fields']

=== Reminder 상태 조회
operation::admin-health-reminder-get[snippets='http-request,http-response,response-fields']
