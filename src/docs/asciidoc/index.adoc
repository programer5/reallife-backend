...
include::{snippets}/follows-create-204/http-request.adoc[]
include::{snippets}/follows-create-204/request-headers.adoc[]
include::{snippets}/follows-create-204/path-parameters.adoc[]
include::{snippets}/follows-create-204/http-response.adoc[]
