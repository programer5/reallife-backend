...
include::{snippets}/auth-logout-all/response-fields.adoc[]
...
include::{snippets}/comments-list-200-next-page/request-headers.adoc[]
include::{snippets}/comments-list-200-next-page/path-parameters.adoc[]
include::{snippets}/comments-list-200-next-page/query-parameters.adoc[]
...
include::{snippets}/comments-list-200-next-page-followup/request-headers.adoc[]
include::{snippets}/comments-list-200-next-page-followup/path-parameters.adoc[]
include::{snippets}/comments-list-200-next-page-followup/query-parameters.adoc[]
include::{snippets}/comments-list-200-next-page-followup/http-response.adoc[]
include::{snippets}/comments-list-200-next-page-followup/response-fields.adoc[]
...
include::{snippets}/comments-delete-400-invalid-uuid/request-headers.adoc[]
include::{snippets}/comments-delete-400-invalid-uuid/path-parameters.adoc[]
...
include::{snippets}/comments-list-400-invalid-cursor/request-headers.adoc[]
include::{snippets}/comments-list-400-invalid-cursor/path-parameters.adoc[]
include::{snippets}/comments-list-400-invalid-cursor/query-parameters.adoc[]
...
include::{snippets}/follows-create-400-self/request-headers.adoc[]
include::{snippets}/follows-create-400-self/path-parameters.adoc[]
...
include::{snippets}/messages-get-404-conversation-not-found/request-headers.adoc[]
include::{snippets}/messages-get-404-conversation-not-found/path-parameters.adoc[]
include::{snippets}/messages-get-404-conversation-not-found/query-parameters.adoc[]
...
[NOTE]
====
메시지 목록 조회 API를 호출하면, 해당 대화방의 마지막 메시지 시각까지 자동으로 읽음 처리(last_read_at)가 갱신됩니다.
====

==== 자동 읽음 처리 호출 예시 (messages-get-auto-read)

include::{snippets}/messages-get-auto-read/http-request.adoc[]
include::{snippets}/messages-get-auto-read/request-headers.adoc[]
include::{snippets}/messages-get-auto-read/path-parameters.adoc[]
include::{snippets}/messages-get-auto-read/query-parameters.adoc[]
include::{snippets}/messages-get-auto-read/http-response.adoc[]

==== unreadCount 변화 예시(메시지 목록 조회 전/후)
...
=== 나만 삭제(숨김)
operation::message-hide[snippets='http-request,path-parameters,request-headers,http-response']

=== 모두 삭제(송신자만)
operation::message-delete-for-all[snippets='http-request,path-parameters,request-headers,http-response']
...
include::{snippets}/conversations-list-200-next-page/request-headers.adoc[]
include::{snippets}/conversations-list-200-next-page/query-parameters.adoc[]
...
include::{snippets}/conversations-list-200-next-page-followup/request-headers.adoc[]
include::{snippets}/conversations-list-200-next-page-followup/query-parameters.adoc[]
include::{snippets}/conversations-list-200-next-page-followup/http-response.adoc[]
include::{snippets}/conversations-list-200-next-page-followup/response-fields.adoc[]

=== 대화방 읽음 처리

include::{snippets}/conversations-read/http-request.adoc[]
include::{snippets}/conversations-read/request-headers.adoc[]
include::{snippets}/conversations-read/path-parameters.adoc[]
include::{snippets}/conversations-read/http-response.adoc[]

==== unreadCount 변화 예시 (읽기 전/후)
...
* URL: `GET /api/sse/subscribe`
* 인증: 필요 (Authorization Bearer 또는 쿠키 access_token)
* 응답: `text/event-stream`

==== 이벤트 종류
|===
|event name |설명 |data 예시

|connected
|연결 확인 이벤트
|`{"serverTime":"2026-02-13T12:55:58.496","lastEventId":null}`
...
|새 알림 생성
|`{"notificationId":"...","type":"...","refId":"...","body":"...","createdAt":"..."}`
|===
...
operation::sse-subscribe[snippets='http-request,request-headers']

[NOTE]
====
SSE 재연결(replay)을 위해 클라이언트는 `Last-Event-ID` 헤더를 보낼 수 있습니다.

- `Last-Event-ID` 값은 "마지막으로 수신한 SSE 이벤트의 id" 입니다.
- 본 프로젝트는 이벤트 id를 다음 규칙으로 통일합니다.
- message-created / message-deleted: `msg:{messageId}`
- notification-created: `noti:{notificationId}`
====